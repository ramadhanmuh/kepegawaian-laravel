...
function showTotalActiveEmployee(baseURL) {
    ...
    xhr.open("GET", baseURL + '/admin/dashboard/total-active-employee?_=' + + new Date().getTime(), true);
...
function showTotalNonActiveEmployee(baseURL) {
    ...
    xhr.open("GET", baseURL + '/admin/dashboard/total-non-active-employee?_=' + + new Date().getTime(), true);
...
function showTotalMaleEmployee(baseURL) {
    ...
    xhr.open("GET", baseURL + '/admin/dashboard/total-male-employee?_=' + + new Date().getTime(), true);
...
function showTotalFemaleEmployee(baseURL) {
    ...
    xhr.open("GET", baseURL + '/admin/dashboard/total-female-employee?_=' + + new Date().getTime(), true);
...
function showTotalEmployeeEducation(baseURL) {
    ...
    xhr.open("GET", baseURL + '/admin/dashboard/total-employee-education?_=' + + new Date().getTime(), true);
...
function showTotalEmployeeAge(baseURL) {
    ...
    xhr.open("GET", baseURL + '/admin/dashboard/total-employee-age?_=' + + new Date().getTime(), true);
