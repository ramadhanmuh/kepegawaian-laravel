...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.employees.store') }}" class="row" method="POST" enctype="multipart/form-data">
                        @csrf
...
@push('scripts')
    ...
    <script defer src="{{ url('assets/js/admin/employee/create.js') }}"></script>
@endpush