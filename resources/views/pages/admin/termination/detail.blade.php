...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-12 mb-3 text-end">
            <a href="{{ route('admin.terminations.edit', $item->id) }}" class="btn btn-warning btn-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <p class="m-0">
                                <a href="{{ route('admin.termination-types.show', $item->termination_type_id) }}" class="text-decoration-none">
