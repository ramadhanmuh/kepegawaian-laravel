...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.employee-education.update', $item->id) }}" class="row" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
...
@push('scripts')
    ...
    <script defer src="{{ url('assets/js/admin/employee-education/edit.js') }}"></script>
@endpush