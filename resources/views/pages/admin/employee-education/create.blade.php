...
@section('title', 'Pendidikan Pegawai - Tambah')

@section('description', 'Halaman untuk menambahkan data pendidikan pegawai.')
...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.employee-education.store') }}" class="row" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="level" id="level" class="form-select" required>
                                ...
                                <option value="s1" {{ old('level') === 's1' ? 'selected' : '' }}>Sarjana (S1)</option>
                                <option value="s2" {{ old('level') === 's2' ? 'selected' : '' }}>Magister (S2)</option>
                                <option value="s3" {{ old('level') === 's3' ? 'selected' : '' }}>Doktor (S3)</option>
                            </select>
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="major" class="form-control" id="major" name="major" value="{{ old('major') }}">
                        </div>
                        <div class="col-12 mb-3">
                            <label for="school_address" class="form-label">Alamat Sekolah/Kampus <small class="text-danger">*</small></label>
                            <textarea name="school_address" id="school_address" rows="3" class="form-control" required>{{ old('school_address') }}</textarea>
                        </div>
                        <div class="col-12">
...
@push('scripts')
    ...
    <script defer src="{{ url('assets/js/admin/employee-education/create.js') }}"></script>
@endpush