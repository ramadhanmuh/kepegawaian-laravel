...
@section('title', 'Pemberhentian Kerja - Tambah')

@section('description', 'Halaman untuk menambahkan data Pemberhentian Kerja.')

@section('content')
    <h1 class="mt-4">Tambah Pemberhentian Kerja</h1>
    ...
    <div class="row mb-3">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('super-admin.terminations.store') }}" class="row" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="termination_type_id" id="termination_type_id" class="form-select" required>
                                ...
                                @forelse ($termination_types as $termination_type)
                                    <option value="{{ $termination_type->id }}" {{ old('termination_type_id') == $termination_type->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control" id="notice_date" name="notice_date" value="{{ old('notice_date') }}">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="termination_date" class="form-label">Tanggal Pemberhentian <small class="text-danger">*</small></label>
                            <input type="date" class="form-control" id="termination_date" name="termination_date" value="{{ old('termination_date') }}">
                        </div>
...
@push('scripts')
    ...
    <script defer src="{{ url('assets/js/super-admin/termination/create.js') }}"></script>
@endpush