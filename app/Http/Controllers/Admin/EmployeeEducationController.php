...
class EmployeeEducationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.admin.employee-education.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('pages.admin.employee-education.create', $data);
    }
    ...
    public function show(string $id)
    {
        ...
        return view('pages.admin.employee-education.detail', $data);
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('pages.admin.employee-education.edit', $data);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('admin.employee-education.index')
