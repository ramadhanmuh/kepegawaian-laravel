...
class TerminationTypeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.admin.termination-type.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('pages.admin.termination-type.create', $data);
    }
    ...
    public function show(string $id)
    {
        ...
        return view('pages.admin.termination-type.detail', $data);
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('pages.admin.termination-type.edit', $data);
    }
